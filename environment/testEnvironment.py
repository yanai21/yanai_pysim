...
deploy1_normalJob_queue = read_NormalJob("test","deploy1")
...
deploy1_urgentJob_queue,deploy1_event = read_UrgentJob("test", "deploy1")
...
aoba_deploy1_environment = Environment(aoba_testSystem,deploy1_normalJob_queue,deploy1_urgentJob_queue,deploy1_event)