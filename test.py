from evaluation import Makespan,ElectricPower
...
def main(name,UrgentFlag,UrgentJobAssignment):
    ...
    try:
        ...
        pass
    global Nodes,empty_node,reservedNodes,now,normalJob_queue,urgentJob_queue,event,result
    #ノード関係
    ...
    while len(event) != 0:
        ...
        for eventJob in reversed(eventJobs):
            ...
            #割り当て前の緊急ジョブ
                ...
                preemptionJobs,startNodes = UrgentJobAssignment(Nodes,empty_node,preemptionJobs,startNodes,reservedNodes,preemptionNodes,now,eventJob,event,result)
            #予約された緊急ジョブ
