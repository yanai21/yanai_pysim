...
# print("ノード起動優先")
# nodeStartMakespan,nodeStartElectricPowerResult = scheduling("nodeStart",True,NodeStartUrgentJobAssignment,test1_environment)
print("通常ジョブのみ")
scheduling("normalJob",False,NormalJobPlacement,test1_environment)
